...
for company_name in company_list:
    ...
    try:
        ...
        with open(r'C:\Users\august.brunnbergfri\Downloads\multiTimeline.csv', 'r') as f:
            reader = csv.reader(f)
        ...
        # delet the file
        os.remove(r'C:\Users\august.brunnbergfri\Downloads\multiTimeline.csv')
